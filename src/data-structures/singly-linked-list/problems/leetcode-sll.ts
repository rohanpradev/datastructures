 ...
 *   we remove the duplicate by skipping the next node.
 * - If the values are different, we safely move forward.
 *
 * This modifies the original list instead of creating a new one.
 *
 * Example:
 * Input:  1 → 1 → 2 → 3 → 3
 * Output: 1 → 2 → 3
 ...
 *
 * @param list - A sorted singly linked list of numbers
