...
describe("LRUCache", () => {
  ...
  test("should update existing key and move it to most recently used", () => {
    const cache = new LRUCache<number, string>(2);
  ...
  test("should move key to most recently used when accessed", () => {
    const cache = new LRUCache<number, string>(2);
  ...
  test("should throw error if capacity is zero or negative", () => {
    expect(() => new LRUCache<number, string>(0)).toThrow();
