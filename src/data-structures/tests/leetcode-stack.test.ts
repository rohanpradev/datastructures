...
import { TreeNode } from "@/data-structures/binary-search-tree/binary-search-tree";
  ...
  describe("evaluate()", () => {
    ...
    describe("complex expressions", () => {
      ...
      test("should evaluate long expression", () => {
        expect(evaluate("1 + 2 + 3 * 4 + (5 * 6) - 7")).toBe(
          1 + 2 + 12 + 30 - 7,
        );
      });
...
describe("nodeDepths()", () => {
  describe("basic functionality", () => {
    ...
    test("should calculate depths for a simple two-level tree", () => {
      //   1
      //  / \
      // 2   3
      const tree = new TreeNode(1);
  ...
  describe("balanced binary trees", () => {
  ...
  describe("unbalanced binary trees", () => {
    test("should calculate depths for a left-skewed tree", () => {
      // 1
      // |
      // 2
      // |
    ...
    test("should calculate depths for a right-skewed tree", () => {
      // 1
      //  \
      //   2
      //    \
      ...
      // depths: 0 + 1 + 2 = 3
      expect(nodeDepths(tree)).toBe(3);
    });
  });

  describe("trees with missing children", () => {
    test("should handle tree with only left children at some nodes", () => {
      //   1
      //  /
      // 2
      //   \
    ...
    test("should handle tree with only right children at some nodes", () => {
      // 1
      //  \
      //   2
      //  /
  ...
  describe("larger trees", () => {
    test("should handle a deeper tree", () => {
      //        1
      //       /
      //      2
      //     /
  ...
  describe("edge cases", () => {
    test("should work correctly when tree has only one branch", () => {
